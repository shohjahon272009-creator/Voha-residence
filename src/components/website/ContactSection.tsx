...
export default function ContactSection({ lang, phone, address, hours }: { lang: Locale; phone?: string; address?: string; hours?: string }) {
  ...
  const t = {
    uz: { 
      ...
      send: "Xabar yuborish",
      addressLabel: "Manzil",
      addressValue: "Xorazm viloyati, Urganch sh., Ulug'bek ko'chasi",
      phoneLabel: "Telefon",
      timeLabel: "Ish vaqti",
    ...
    ru: { 
      ...
      addressLabel: "Адрес",
      addressValue: "Хорезмская область, г. Ургенч, ул. Улугбека",
      phoneLabel: "Телефон",
    ...
    en: { 
      ...
      addressValue: "Khorezm region, Urgench, Ulugbek street",
      phoneLabel: "Phone",
